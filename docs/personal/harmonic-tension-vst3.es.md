...
La propia clase del procesador todavía se llama `ProgettoProvaAudioProcessor` ("proyecto de prueba" en italiano) en el código fuente, un resto de nomenclatura del scaffolding de proyecto de JUCE que indica que esto siguió siendo un prototipo funcional en lugar de una versión pulida y renombrada. El [PDF del modelo Spiral Array](https://drive.proton.me/urls/KHMJ76J6RR#cSM_oJpX6Ky4) que acompaña al repositorio documenta el modelo geométrico subyacente y el caso de uso de iluminación inteligente con más profundidad de la que ofrecen los comentarios del código.
