...
**Technologies**: Proxmox VE, PowerShell, REST API for infrastructure snapshots, technical documentation aligned with ISO/IEC 27001
...
A single, updatable source of truth for the state of the network, which reduces dependence on the tacit knowledge of whoever carried out individual interventions and speeds up both security audits and onboarding onto a new intervention.
