...
**Tecnologie**: Proxmox VE, PowerShell, API REST per lo snapshot di infrastruttura, documentazione tecnica allineata a ISO/IEC 27001
...
Una fonte di verità unica e aggiornabile per lo stato della rete, che riduce la dipendenza dalla conoscenza tacita di chi ha eseguito i singoli interventi e velocizza sia gli audit di sicurezza sia l'onboarding su un intervento nuovo.
